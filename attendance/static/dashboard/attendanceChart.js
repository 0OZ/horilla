...
$(document).ready(function () {
    ...
    function emptyOvertimeChart(departmentAttendanceChart, args, options) {
        ...
        for (
            let i = 0;
            i < departmentAttendanceChart.data.datasets.length;
            i++
        ) {
            flag =
                flag +
                departmentAttendanceChart.data.datasets[i].data.some(Boolean);
        }
        if (!flag) {
    ...
    $("#departmentChartCard").on(
        "change",
        "#department_date_type",
        function (e) {
                    ...
                    options: {
                        ...
                        onClick: (e, activeEls) => {
                            ...
                            let datasetLabel =
                                e.chart.data.datasets[datasetIndex].label;
                            let value =
                                e.chart.data.datasets[datasetIndex].data[
                                    dataIndex
                                ];
                            let label = e.chart.data.labels[dataIndex];
                            parms =
